...
-- Employees --
insert into Employee (firstname, lastname, email, tel, username, password) values ('Dayle', 'Hugill', 'dhugill0@amazonaws.com', '3726956069', 'dhugill0', 'placeholderPassword');
insert into Employee (firstname, lastname, email, tel, username, password) values ('Ado', 'Olivey', 'aolivey1@privacy.gov.au', '2534449079', 'aolivey1', 'placeholderPassword');
insert into Employee (firstname, lastname, email, tel, username, password) values ('Laurena', 'Pounsett', 'lpounsett2@yolasite.com', '6081250253', 'lpounsett2', 'placeholderPassword');
insert into Employee (firstname, lastname, email, tel, username, password) values ('Dolly', 'Bingell', 'dbingell3@indiatimes.com', '8259904853', 'dbingell3', 'placeholderPassword');
insert into Employee (firstname, lastname, email, tel, username, password) values ('Chilton', 'Oxx', 'coxx4@columbia.edu', '3381945769', 'coxx4', 'placeholderPassword');
-- TextBlock --
